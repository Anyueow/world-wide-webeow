...
| --- | --- | --- | --- |
| A-1 | **One resume PDF** | `/public/resume/ananya-shah.pdf` | Ananya requested a single general resume on 2026-09-22, superseding the three variants. Supply this PDF; the page shows one unavailable slot until it exists, then one download link. |
